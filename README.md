...
| 3.1 Product Review Summarization                                |    Hugging Face tokenizer                           | `distilbert-base-uncased`                                     |          |          |       the new transformers did not provide the summarization task                                                                                        | 
| 3.2 Product Review Summarization  | Prompted generation         | `meta-llama/Llama-3.2-3B-Instruct` | n/a (generative) | — | Evaluated qualitatively (readability/faithfulness of generated summaries), not via classification accuracy (Note: This is a Gated Model) |
| 5.                                |                              |                                     |          |          |                                                                                               |
| 6.                                |                              |                                     |          |          |                                                                                               |
